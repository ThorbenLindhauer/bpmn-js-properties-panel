    ...
    group.entries.push(
      {
        ...
        'html': '<label for="camunda-class">Delegate Method</label>' +
                ...
                '<ul class="radios-group">' +
                  '<li>' +
                    '<input type="radio" id="resolution-class" name="delegate-resolution" value="class">' +
                    '<label for="resolution-class">Class</label>' +
                  '</li>' +
                  '<li>' +
                    '<input type="radio" id="resolution-delegateExpression" name="delegate-resolution" value="delegateExpression">' +
                    '<label for="resolution-delegateExpression">Delegate Expression</label>' +
                  '</li>' +
                  '<li>' +
                    '<input type="radio" id="resolution-expression" name="delegate-resolution" value="expression">' +
